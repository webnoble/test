<template>
  <div class="server">
    ...
    <el-row v-for="item in systemData" :key="item.id" class="line" type="flex" justify="center" align="middle">
      ...
      <el-col :span="5">
        <el-input v-model="item.multiple" :disabled="disabledStatus" class="mini" />
